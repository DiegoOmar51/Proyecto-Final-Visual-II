    ...
    public partial class db1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_empresas_roles_RolesId",
                        column: x => x.RolesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SalarioDetalleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalarioDetalle", x => x.SalarioDetalleId);
                    table.ForeignKey(
                        name: "FK_SalarioDetalle_empresas_EmpresaId",
                        column: x => x.EmpresaId,
                        principalTable: "empresas",
                        principalColumn: "EmpresaId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalarioDetalle_roles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "roles",
                        principalColumn: "RolesId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalarioDetalle_salarios_SalarioId",
                        column: x => x.SalarioId,
                        principalTable: "salarios",
                        principalColumn: "SalarioId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalarioDetalle_EmpresaId",
                table: "SalarioDetalle",
                column: "EmpresaId");

            migrationBuilder.CreateIndex(
                name: "IX_SalarioDetalle_RolesId",
                table: "SalarioDetalle",
                column: "RolesId");

            migrationBuilder.CreateIndex(
                name: "IX_SalarioDetalle_SalarioId",
                table: "SalarioDetalle",
                column: "SalarioId");
